...
//	u64 timeout = 0;
	...
	*(vu32*)0x92FFFFC0 = isWiiVC; //cant be detected in IOS
	...
	{
		ShowMess("Checking storage devices... LINE 858 autobooting");
		// Autobooting.
	...
	ShowMess("Checking storage devices... LINE 862");
...
//Init DI and set correct ID if needed
	...
	ShowMess("Checking storage devices... LINE 936");
	...
	ShowMess("Checking storage devices... LINE 977");
	...
	ShowMess("Checking storage devices... LINE 1041");
...
//Set Language
	...
	ShowMess("Checking storage devices... LINE 1211");
...
//hand over approx time passed since 1970
	*(vu32*)0xD3003424 = (cur_time+946684800);
	...
	ShowMess("Checking storage devices... LINE 1249");
...
//	memcpy( (void*)0x80000000, (void*)0x90140000, 0x1200000 );
	...
	ShowMess("Checking storage devices... LINE 1396");
	...
	ShowMess("Checking storage devices... LINE 1514");
	...
	*(vu32*)0x93003008 = 0x80000004; //just some address for SIGetType
	...
	ShowMess("Checking storage devices... LINE 1581");
	...
	ShowMess("Checking storage devices... LINE 1643");
	...
	ShowMess("Checking storage devices... LINE 1655");
