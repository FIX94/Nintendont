...
int KeyboardStub(u32 a, u32 *b)
{
	if(a == 0)
	{
		...
		*b = key1<<24 | key2<<16 | key3<<8;
		//OSReport("KeyboardStub %02x%02x%02x %08x\n", kb_input[2], kb_input[3], kb_input[4], *b);
		return 0;
	}
	return -1;
}
