...
//	{ 0x94,			0,      0,      0,      0,      0,	(u8*)NULL,					0xdead0010,						"C_MTXOrtho",					0,		0 },
  ...
  { 0x98,     19,     9,      4,      0,      2, (u8*)NULL,					0xdead0002,						"GCAMIdentify",					0,		0 },
	...
	{ 0x308,        40,     18,     10,		23,		17,	patch_fwrite_Log,			sizeof(patch_fwrite_Log),		"__fwrite A",					7,		0 },
	{ 0x338,        48,     20,     10,		24,		16,	patch_fwrite_Log,			sizeof(patch_fwrite_Log),		"__fwrite B",					7,		0 },
	{ 0x2D8,        41,     17,     8,		21,		13,	patch_fwrite_Log,			sizeof(patch_fwrite_Log),		"__fwrite C",					7,		0 },
	{ 0x1FC,        47,     4,      14,		18,		7,	patch_fwrite_LogB,			sizeof(patch_fwrite_LogB),		"__fwrite D",					7,		0 },
