...
enum ninvideomodeindex
{
	...
	NIN_VID_INDEX_FORCE_DF	= (2),
	NIN_VID_INDEX_NONE		= (3),
...
enum ninvideomode
{
	NIN_VID_AUTO		= (1<<NIN_VID_INDEX_AUTO    <<16),
	NIN_VID_FORCE		= (1<<NIN_VID_INDEX_FORCE   <<16),
	NIN_VID_FORCE_DF	= (1<<NIN_VID_INDEX_FORCE_DF<<16),
	NIN_VID_NONE		= (1<<NIN_VID_INDEX_NONE    <<16),

	NIN_VID_MASK		= NIN_VID_AUTO|NIN_VID_FORCE|NIN_VID_FORCE_DF|NIN_VID_NONE,
