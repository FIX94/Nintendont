...
enum ninconfigbitpos
{
	...
	NIN_CFG_BIT_TRI_ANALOG_PEDALS = (17),
	NIN_CFG_BIT_CC_RUMBLE	= (18),
	NIN_CFG_BIT_SKIP_IPL	= (19),
	NIN_CFG_BIT_BBA_EMU		= (20),
...
enum ninconfig
{
	...
	NIN_CFG_TRI_ANALOG_PEDALS = (1<<NIN_CFG_BIT_TRI_ANALOG_PEDALS),
